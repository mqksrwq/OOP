...
namespace Lab7
{
    ...
    public class HotelsHashtableCollection : IHotelComponent
    {
        ...
        /// <summary>
        /// Возвращает текстовое описание коллекции и всех вложенных элементов.
        /// </summary>
        /// <param name="indent">Отступ слева в пробелах.</param>
        /// <returns>Строка с иерархическим описанием.</returns>
        ...
        /// <summary>
        /// Ищет компонент по имени в текущей коллекции и во всех вложенных узлах.
        /// </summary>
        /// <param name="name">Имя компонента для поиска.</param>
        /// <returns>Найденный компонент или <c>null</c>.</returns>
